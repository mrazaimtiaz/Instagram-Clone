...
public class LoginActivity extends AppCompatActivity {
     ...
     */
     private void init(){
         //intializing the button for logging in
                             ...
                             .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                                 ...
                                 public void onComplete(@NonNull Task<AuthResult> task) {
                                     if (task.isSuccessful()) {
                                         ...
                                         try {
                                               if(user.isEmailVerified()){
                                                   ...
                                                   Toast.makeText(mContext, "email is not verified check your mail inbox", Toast.LENGTH_SHORT).show();
                                                   mProgressBar.setVisibility(View.GONE);
                                                   mPleaseWait.setVisibility(View.GONE);
                                                   mAuth.signOut();
                                               }
                                         ...
                                         /*
                                         if the user is logged in then navigate to the home activity and call finish()
                                         */
                                     ...
                                     if(mAuth.getCurrentUser() != null) {
                                         Log.d(TAG, "init: navigatiing to home screen after succesful login");
                                         Intent intent = new Intent(LoginActivity.this, HomeActivity.class);
                                         startActivity(intent);
                                         finish();
                                     }
