...
public class PhotoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnLaunchCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(TAG, "onClick: Lauching Camera");
                ...
                if(((ShareActivity)getActivity()).getCurrentTabNumber()== PHOTO_FRAGMENT_NUM){
                    if(((ShareActivity)getActivity()).checkPermissions(Permissions.CAMERA_PERMISSION[0])){
                        ...
                        Intent intent = new Intent(new Intent(getActivity(),ShareActivity.class));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == CAMERA_REQUEST_CODE){
            ...
            Log.d(TAG, "onActivityResult: atempting to navigate to final screen");
            try{
                Bitmap bitmap;
            ...
            if(isRootTask()){
                try{
                    Log.d(TAG, "onActivityResult: recived new bitmap from camera " + bitmap);
